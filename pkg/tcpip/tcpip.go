...
type WriteOptions struct {
	...
	// Atomic means that all data fetched from the io.Reader must be written to
	// the endpoint. If Atomic is false then data fetched from the io.Reader may
	// be discarded if available endpoint buffer space is insufficient.
	Atomic bool
}
